...
==========================================================================
Demo the work mode of software watchdog timer:
1) interrupt
2) reset
...
1) Prepare the configuation data in: 
   WD_HardConfigInfoT for timer interval
2) Select the corresponding work mode
   WD_SoftIntEnable for interrupt mode 
   WD_SoftResetEnable reset mode
3) Run 
4) Check whether interrupt or reset generate
