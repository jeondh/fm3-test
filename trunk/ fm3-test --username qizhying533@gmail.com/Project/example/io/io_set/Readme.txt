...
==========================================================================
Demo the read and write function of IO:
...
Usage Procedure:
==========================================================================
1) Configure IO type as GPIO
   IO_GPIO_MODE for GPIO mode
2) Select the corresponding work mode
   IO_GPIOSetOutput for output mode
   IO_GPIOSetInput for input mode
3) Run
4) Check the value of readdata for read function
   check the voltage of corresponding pins for write function
