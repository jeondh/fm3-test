...
==========================================================================
Demo the 3 types of work mode of Dual Timer:
1) OneShot
2) FreeRun
3) Periodic

The user can select to run:
DTOneShot or DTFreeRun or DTPeriodic
...
Usage Procedure
==========================================================================
1) Prepare the configuation data in: 
tDT_ConfigTOneShot for OneShot mode
tDT_ConfigTFreeRun for FreeRun mode
tDT_ConfigTPeriodic for Periodic mode
2) Select the corresponding work mode
3) Run
4) Check the value of ltmp by IAR debug watch
