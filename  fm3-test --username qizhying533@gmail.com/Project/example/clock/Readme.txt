...
==========================================================================
Demo the master clock switch function:
1) Internal high-speed CR oscillation
2) Main oscillation clock
3) PLL oscillation clock
4) Internal low-speed CR oscillation.
5) Sub clock oscillation

User can measure the cycle of output PWM waveform for switching master clock
sucessfully.
...
Usage Procedure:
==========================================================================
1) Debug and run sample code
2) Measure and check waveform from output pin (P40).
