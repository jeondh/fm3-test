...
2011-12-26 1.0 MCU 6.21.1 ----    New
==========================================================================

==========================================================================
Function description:

Implement USB mouse on the FSSDC-9B506-EVB.
==========================================================================
...
1) Short 1,2 of J-USB- and J-USB+
2) Short J701 if 5V power supply is used.
3) After code is running, connect the EV-board with PC via USB cable
4) Press the Up/Down/Left/Right Key, and watch the mouse moves at the
screen.
